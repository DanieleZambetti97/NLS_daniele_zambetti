...
int main(int argc, char* argv[]){
	...
	DataBlocking ("./risultati/output_temp.dat", nstep, blocklength, "./risultati/ave_temp.dat");
	DataBlocking ("./risultati/output_epot.dat", nstep, blocklength, "./risultati/ave_epot.dat");
	DataBlocking ("./risultati/output_etot.dat", nstep, blocklength, "./risultati/ave_etot.dat");
	DataBlocking ("./risultati/output_ekin.dat", nstep, blocklength, "./risultati/ave_ekin.dat");
	DataBlocking ("./risultati/output_pres.dat", nstep, blocklength, "./risultati/ave_pres.dat");
