...
// contribution to energy and virial
  ...
  Epot.open("./risultati/output_istant_epot.dat",ios::app);
  Pres.open("./risultati/output_istant_pres.dat",ios::app);
  Epot << walker[iv]+vtail << endl;
...
void Averages(int iblk) //Print results for current block
{
   ...
   ofstream Gofr, Gave, Epot, Pres;
    ...
    Epot.open("./risultati/output_ave_epot.dat",ios::app);
    Pres.open("./risultati/output_ave_pres.dat",ios::app);
